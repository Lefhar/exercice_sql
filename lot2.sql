...
SELECT res_cli_id, cli_id, res_date_debut, res_date_fin,DATEDIFF( res_date_fin,  res_date_debut), res_cha_id, cha_id, hot_id, hot_nom, cli_nom from client JOIN reservation ON res_cli_id = cli_id JOIN chambre ON cha_id = res_cha_id join hotel on hot_id = cha_hot_id
